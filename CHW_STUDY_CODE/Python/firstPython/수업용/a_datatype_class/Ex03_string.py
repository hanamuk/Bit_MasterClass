...
""" [ 연습-1 ]
    ...
    '12시 5분' 출력
"""
time = '2020-02-22 : 12:05:12'
print(time[0:11]+'일')
print(time[13:15]+'시 '+time[17:18]+'분')


# -----------------------------------------
#  (4-1) 문자열 관련 함수
#       s.count('글') : s 문자열에서 '글'이라는 문자 개수 세기
#       s.index('글') : s 문자열에서 문자 '글' 위치 알려주기 , 못찾으면 오류 종료
#       s.find('글') : s 문자열에서 문자 '글' 위치 알려주기 ,못찾으면 -1반환
...
print(msg)
print(msg.split()) #결과는 리스트형 으로 나온다
print(msg.split())
print('.'.join(msg))


#기타
print(msg.endswith('다')) # '다'이라는 문자로 끝나는가
print(msg.startswith('우리')) #'우리'라는 문자로 시작하는가
print('45'.zfill(4))    #45로 fill을 채운다. 즉 .4자리에서 남는 자리수는 45로 채운다?

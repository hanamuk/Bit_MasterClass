...
dt = {1:'one', 2:'two', '3':'three',1:'first'} #first를 덮어쓴다.
...
#print(dt2[3]) 없는키 할떄 예외 발생
print(dt2.get(3)) #없을떄 none
print(dt2.get(3,'없음')) #없을떄 '없음'
...
print(dt2.keys())
print(dt2.values())
print(dt2.items()) #각 요소를 튜플로 묶이고 각튜플에서 키와 값이 튜플로 묶인다.

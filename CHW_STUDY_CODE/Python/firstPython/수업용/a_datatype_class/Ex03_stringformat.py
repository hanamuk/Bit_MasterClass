...
msg ='{}님 오늘도 행복하세요'
print(msg.format('홍길동')) #순서 숫자지정이 없다면 0부터
...
print('%s님은 %d세 이고, 신장은 %10.3fcm 입니다' %(name, age, height))

#--------------------------------------------------
# 실수인 경우

print('내가좋아하는 숫자는', '7.77')
print('내가좋아하는 숫자는 %.2f' %7.77)
print('내가좋아하는 숫자는{0:.2f}이다'. format(9.99))

print('내가좋아하는 숫자는', 7.77777)
print('내가좋아하는 숫자는 %.2f이다' %7.77777)
print('내가좋아하는 숫자는{0:.2f}이다'. format(9.99999))   #자동반올림

...
void CEnumProcessesDlg::OnBnClickedButton1()
{
	...
	//지금 실행중인 프로세스들의 PID를 가져오는 함수
	EnumProcesses(pidArray, sizeof(pidArray), &cdNeeded); //pidArray여기다 넣고, 읽어진 갯수를 반환
	...
	for(int i=0; i<=nProcesses; i++)
	{
		...
		{
			TCHAR szBuffer[200];
			GetModuleFileNameEx(hProcess, NULL, szBuffer, sizeof(szBuffer)); //pid프로그램의 이름 

...
BEGIN_MESSAGE_MAP(CEnumProcessesDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_PROCESS, &CEnumProcessesDlg::OnBnClickedButtonProcess)
	ON_BN_CLICKED(IDC_BUTTON_THREAD, &CEnumProcessesDlg::OnBnClickedButtonThread)
END_MESSAGE_MAP()
...
void CEnumProcessesDlg::OnBnClickedButtonProcess()
{
	// 1. ID를 읽어온다
	UpdateData(1);
...
void CEnumProcessesDlg::OnBnClickedButtonThread()
{
